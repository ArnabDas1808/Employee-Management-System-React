  ...
  return (
    <div className='bg-[#1c1c1c] p-5 rounded mt-5 '>
        ...
        <div className=' '>
            ...
            return <div key={idx} className='border-2 border-emerald-500 mb-2 py-2 px-2 flex justify-between rounded'> 
                <h2 className='text-lg font-medium w-1/4'>{elem.firstName}</h2>
